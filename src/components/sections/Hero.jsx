      ...
      <div className="self-center">
        ...
        <div className="flex gap-2 align-center flex-wrap md:flex-nowrap">
          <div className="lg:w-[80%] text-zinc-900 dark:text-zinc-100 self-center">
            ...
            {user_info.main.description.split("\n\n").map((paragraph, index) => (
              <p key={index} className="mt-6 dark:text-zinc-300 text-base font-light lg:w-[87%] leading-7">
                {paragraph}
              </p>
            ))}
          ...
          <div className="hidden lg:block w-[480px] self-center">
            <img
              ...
              src={user_info.main.photo}
              alt="Neel Patel Graduation Picture"
            />
          </div>
        </div>
      </div>
